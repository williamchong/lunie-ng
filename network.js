export default {
  id: 'likecoin-chain-internal-testnet-2', // DEPRECATE, only used for Lunie extension, NOT CHAIN ID
  name: 'LikeCoin internal test chain',
  description:
  ...
  apiURL: 'https://internal-testnet-lcd.nnkken.dev', // use `npx lcp --proxyUrl http://34.123.30.100:1317`
  rpcURL: 'https://internal-testnet-lcd.nnkken.dev',
